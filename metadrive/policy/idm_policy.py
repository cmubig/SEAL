...
class IDMPolicy(BasePolicy):
    ...
    def acceleration(self, front_obj, dist_to_front) -> float:
        ...
        # if self.disable_idm_deceleration:
        #     return 1
...
class TrajectoryIDMPOlicy(IDMPolicy):
    ...
    def __init__(self, control_object, random_seed, traj_to_follow, policy_index=None, ignore_others=False):
        ...
        if self.ignore_others:
            self.disable_idm_deceleration = True
        self.target_speed = self.NORMAL_SPEED
