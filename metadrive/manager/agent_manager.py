...
class AgentManager(BaseManager):
    ...
    def try_actuate_agent(self, step_infos, stage="before_step", **kwargs):
        """
        ...
        for agent_id in self.active_agents.keys():
            ...
            if cond_2 or cond_1:
                ...
                # Hmmm, this invocation of before_step is the one that resets vehicle_crash flag...
                # if 'crash_vehicle' in kwargs and kwargs['crash_vehicle']:
                #     breakpoint()
    ...
    def after_step(self, *args, **kwargs):
        ...
        step_infos = self.try_actuate_agent(step_infos, stage="after_step", **kwargs)
        return step_infos
