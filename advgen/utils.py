...
def select_goals_by_NMS(mapping: Dict, goals_2D: np.ndarray, scores: np.ndarray, threshold, speed, gt_goal=None, mode_num=6):
    ...
    pred_probs = []
    pred_indices = []
    # This is where the pred goals, etc. actually get set per example!
    # At this point goals_2D is the massive 50176 x 2, aka (224^2 x 2)
    # and scores is also (50176,)
    # so this step is just doing NMS
    ...
    # Want to check if gt_goal is true, and also if diverse modes are selected
